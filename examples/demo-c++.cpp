...
class myTask:public CTask
{
	public:
		 ...
		 * and we can retreive its address by calling @getProxy()
		 */
	...
	private:
		...
		virtual void  onTaskComplete(long sm, int errCode) 
		{
			 ...
			 * @sm_ONCE_AGAIN will be removed by the pool after its having
